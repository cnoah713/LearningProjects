...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_rich = round(len(df[df['education'].isin(higher_education) & (df['salary'] == '>50K')]) / len(df[df['education'].isin(higher_education)]) * 100, 1)
    lower_education_rich = round(len(df[~df['education'].isin(higher_education) & (df['salary'] == '>50K')]) / len(df[~df['education'].isin(higher_education)]) * 100, 1)
